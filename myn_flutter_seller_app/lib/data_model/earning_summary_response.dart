...
EarningSummaryResponse earningSummaryResponseFromJson(String str) =>
    EarningSummaryResponse.fromJson(json.decode(str));

String earningSummaryResponseToJson(EarningSummaryResponse data) =>
...
class EarningSummaryResponse {
  ...
  factory EarningSummaryResponse.fromJson(Map<String, dynamic> json) =>
      EarningSummaryResponse(
