...
CollectionSummaryResponse collectionSummaryResponseFromJson(String str) =>
    CollectionSummaryResponse.fromJson(json.decode(str));

String collectionSummaryResponseToJson(CollectionSummaryResponse data) =>
